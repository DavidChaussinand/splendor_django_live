...
from . import views
from .views import user_login, user_logout, register ,game_view ,login_view , CreerPartieView , RejoindrePartieView ,GameView,GetPlayerStatusView
...
urlpatterns = [
    ...
    path('status/<str:nom_partie>/', GetPlayerStatusView.as_view(), name='get_player_status'),  # Nouvelle URL
]